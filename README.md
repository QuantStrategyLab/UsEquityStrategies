...
| `qqq_tech_enhancement` | QQQ Tech Enhancement | `InteractiveBrokersPlatform`, `LongBridgePlatform` | `monthly` | `QQQ` | `parallel_cash_buffer_branch` | `runtime_enabled` |
...
| `qqq_tech_enhancement` | QQQ 科技增强 | `InteractiveBrokersPlatform`, `LongBridgePlatform` | tech-heavy 月频个股选择，做受控回调，并显式保留 BOXX 缓冲 |
