...
tecl_xlk_trend_income_manifest = _manifest(
    ...
    description="TECL / XLK technology trend switch with BOXX parking and additive income sleeve.",
    aliases=(),
    required_inputs=frozenset({"derived_indicators", "portfolio_snapshot"}),
    default_config={
        ...
        "min_trade_floor": 100.0,
        "rebalance_threshold_ratio": 0.01,
        **income_layer_default_config("tecl_xlk_trend_income"),
        **option_overlay_default_config("tecl_xlk_trend_income"),
        "trend_entry_buffer": 0.08,
        "trend_mid_buffer": 0.06,
        "trend_exit_buffer": 0.02,
