...
def test_drift_workflow_wires_real_snapshot_history_and_preflight_bundle() -> None:
    ...
    assert "ref: 5d6c6bcd970b4a179ccbd21a195e273b17fb59ef" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@5d6c6bcd970b4a179ccbd21a195e273b17fb59ef" in workflow
    ...
    assert "quant_platform_kit_ref: 5d6c6bcd970b4a179ccbd21a195e273b17fb59ef" in workflow
