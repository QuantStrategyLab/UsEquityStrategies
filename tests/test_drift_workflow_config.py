...
def test_drift_workflow_wires_real_snapshot_history_and_preflight_bundle() -> None:
    ...
    assert "ref: 2341557b8ded834bd41ef5a92111361dbf8844d9" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@2341557b8ded834bd41ef5a92111361dbf8844d9" in workflow
    ...
    assert "quant_platform_kit_ref: 2341557b8ded834bd41ef5a92111361dbf8844d9" in workflow
