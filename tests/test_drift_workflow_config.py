...
def test_drift_workflow_wires_real_snapshot_history_and_preflight_bundle() -> None:
    ...
    assert "ref: bc91e88e16d3aa40157d1bf044e7b780f498e0ba" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@bc91e88e16d3aa40157d1bf044e7b780f498e0ba" in workflow
    ...
    assert "quant_platform_kit_ref: bc91e88e16d3aa40157d1bf044e7b780f498e0ba" in workflow
