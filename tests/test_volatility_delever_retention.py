...
def test_tecl_rebound_policy_requires_rebound_confirmation() -> None:
    decision = resolve_volatility_delever_retention(
        mode="environment",
        fixed_ratio=0.0,
        policy="tecl_step_rebound_0.25_0.50",
        max_ratio=0.50,
        context_required=True,
        market_regime_context=_context(constructive=True, rebound_confirm=False),
    )
...
def test_tecl_rebound_policy_retains_half_for_constructive_rebound() -> None:
    decision = resolve_volatility_delever_retention(
        mode="environment",
        fixed_ratio=0.0,
        policy="tecl_step_rebound_0.25_0.50",
