...
| `russell_top50_leader_rotation` | Concentrated leader rotation | `35%` | `8%` | Starts at `35%`, tightens `2%` per double, floor `28.25%` | `25%` | Top2/Top4 concentration needs a Tech-like budget curve, but the cap is lower to avoid muting strong trend capture too much. |
